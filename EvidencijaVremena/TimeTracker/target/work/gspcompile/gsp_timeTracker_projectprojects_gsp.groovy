...
class gsp_timeTracker_projectprojects_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/project/projects.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
expressionOut.print(resource(dir: 'js', file: 'flexigrid.js'))
printHtmlPart(6)
...
public static final long LAST_MODIFIED = 1388743226277L
