...
<html>
    ...
    <body>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input data-val="true" data-val-length="Must be between 3 and 20 charaters." data-val-length-max="20" data-val-length-min="3" data-val-required="This is required" id="Username" name="Username" type="text" value="${user.Username}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <div style="display:none;"><input data-val="true" data-val-required="The Admin field is required." id="Admin" name="Admin" type="checkbox" value="true"><input name="Admin" type="hidden" value="false"> View statistics <br></div>
            </div>
        </div>
        <p>
